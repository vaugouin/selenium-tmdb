...
fichier le 2026-09-05 pour wikidata-id-serie-replace.sql. Ecrire par-dessus une valeur
...
/* ⚠ GARDE 2 : CE FICHIER NE REMPLIT QUE LES CASES VIDES OU ILLISIBLES.
   ...
   2026-09-05 dans wikidata-id-serie-replace.sql, qui applique en plus un garde 3 :
   n'exporter un remplacement que si le QID candidat designe lui-meme cette fiche TMDb
   en P4983. Mesure du 2026-09-05 sur les films, sur 752 remplacements possibles,
...
/* ⚠ LE BLOC « les deux cas cherches, en OU » A ETE RETIRE LE 2026-09-05, et son
   ...
   Il testait ( IS NULL OR = '' OR mal forme OR <> WS.ID_WIKIDATA ). Le garde 2
