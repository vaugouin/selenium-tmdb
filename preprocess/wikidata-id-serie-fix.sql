...
La requete lisait T_WC_WIKIDATA_SERIE_V1, ou ID_WIKIDATA, ID_IMDB et l'identifiant
...
externes sont des STATEMENTS, P345 pour IMDb et P4983 pour TMDb. D'ou la forme
...
AND NOT EXISTS (
      ...
      WHERE e2.VALUE_EXTERNAL_ID = imdb.VALUE_EXTERNAL_ID
        AND w2.ID_WIKIDATA <> WS.ID_WIKIDATA )
